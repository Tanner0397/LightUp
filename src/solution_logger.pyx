...
"""
def new_entry(evals, average_fitness, average_shine_fitness, average_wall_fitness, best_fitness, best_shine_fitness, best_wall_fitness):
    log_file_name = config.get('PATHS', 'log_path')
    with open(log_file_name, 'a') as file:
        file.write("{} \t {:.3f} \t {} \t {:.3f} \t {} \t {:.3f} \t {} \n".format(evals, average_fitness, best_fitness
        , average_shine_fitness, best_shine_fitness, average_wall_fitness, best_wall_fitness))
